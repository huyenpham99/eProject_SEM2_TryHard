...
$config['licenseName'] = 'healthyfood.herokuapp.com';
$config['licenseKey']  = 'R4D4B36GV7VYMWB4USECVL6JB5JEK';
...
$config['backends']['default'] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => config('app.url').'/fileupload/',
    'root'         => public_path('/fileupload/'),
    'chmodFiles'   => 0777,
    'chmodFolders' => 0755,
