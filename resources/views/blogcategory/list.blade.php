            ...
            <div class="card">
                ...
                <div class="card-header border-0">
                    ...
                    <div class="mb-0 col-lg-3 float-right d-flex justify-content-end">
                        <a href="{{url("admin/new-blogcategory")}}" class="btn btn-sm btn-neutral">Create</a>
                    </div>
                </div>
                <!-- Light table -->
                    ...
                    <table class="table align-items-center table-flush">
                        ...
                        @foreach($blogcategories as $blogcategory)
                            <tr>
                                ...
                                <td>
                                    <a href="{{url("admin/edit-blogcategory/{$blogcategory->__get("id")}")}}" class="btn btn-outline-warning">Edit</a>
